...
var desk = require('./desk-0695e28b.js');
...
const Root$5 = styled__default.default(ui.MenuItem)(_ref17 => {
  let {
    state = "enabled",
    isHovered,
    theme
...
const JSONInspectorWrapper = styled__default.default.div(_ref23 => {
  let {
    theme
  } = _ref23;
  const {
...
const ReferenceChangedBanner = React.memo(() => {
  ...
  const referenceInfo = reactRx.useMemoObservable(() => {
    ...
    operators.debounceTime(750), operators.map(_ref24 => {
      let {
        draft,
        published
      } = _ref24;
...
const DocumentPanelHeader = React.memo(React.forwardRef((_ref26, ref) => {
  let {
    rootElement
  } = _ref26;
  const {
...
const Scroller = styled__default.default(sanity.ScrollContainer)(_ref27 => {
  let {
    $disabled
  } = _ref27;
  if ($disabled) {
...
const DeskTool = React.memo(function DeskTool2(_ref33) {
  let {
    onPaneChange
  } = _ref33;
  var _a;
...
//# sourceMappingURL=index-3ee7f3fd.js.map
