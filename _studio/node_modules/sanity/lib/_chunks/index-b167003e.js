...
const paneMap = {
  component: lazy(() => import('./index-f7e2fcf3.js')),
  document: lazy(() => import('./index-04cc5656.js')),
  documentList: lazy(() => import('./index-7df237fe.js')),
  list: lazy(() => import('./index-58d53f9a.js'))
};
...
const Root$5 = styled(MenuItem)(_ref17 => {
  let {
    state = "enabled",
    isHovered,
    theme
...
const JSONInspectorWrapper = styled.div(_ref23 => {
  let {
    theme
  } = _ref23;
  const {
...
const DocumentPanelHeader = memo(forwardRef((_ref26, ref) => {
  let {
    rootElement
  } = _ref26;
  const {
...
const Scroller = styled(ScrollContainer)(_ref27 => {
  let {
    $disabled
  } = _ref27;
  if ($disabled) {
...
const DeskTool = memo(function DeskTool2(_ref33) {
  let {
    onPaneChange
  } = _ref33;
  var _a;
...
//# sourceMappingURL=index-b167003e.js.map
